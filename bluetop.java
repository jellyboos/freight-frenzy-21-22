...
@Autonomous(name="bluetop", group="Pushbot")
...
public class bluetop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        timedMotorPowers(BACK_SPEED,1.13);
        pause();
        runtime.reset();
        ...
        sleep(1000);
        outtakeMovement(-0.5, 0.58);
        pause();
        robot.outtake.setPower(0);
        sleep(1000);
        timedMotorPowers(-BACK_SPEED, 0.1);
        pause();
        timedMotorPowers(-BACK_SPEED,BACK_SPEED,-BACK_SPEED,BACK_SPEED,0.25);
        pause();
        runtime.reset();
        timedMotorPowers(-0.7, 0.7, 0.7, -0.7, 2.5);
        pause();
        timedMotorPowers(0.4, 1.3);
        pause();
        timedMotorPowers(0.15,0.3);
        pause();
