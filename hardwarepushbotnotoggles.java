...
public class HardwarePushbot {
    ...
    public static final int BOTTOM_OUTTAKE_POSITION = 10;
    public static final int MID_OUTTAKE_POSITION = 750;
    public static final int TOP_OUTTAKE_POSITION = 1500;
    public static final double OUTTAKE_SPEED_UP = 0.5;
    public static final double OUTTAKE_SPEED_DOWN = -0.5;
//    public static final double OUTTAKE_SPEED_UP = 0.005 * 435 * 1425.1 / 60;
//    public static final double OUTTAKE_SPEED_DOWN = -0.005 * 435 * 1425.1 / 60;
    public static final double CAROUSEL_POWER_LEFT = 0.22;
    public static final double CAROUSEL_POWER_RIGHT = -0.22;
    ...
    public static final double BUCKET_OPEN_POSITION = 250.0/360.0;
    public static final double BUCKET_CLOSE_POSITION = 100.0/360.0;
