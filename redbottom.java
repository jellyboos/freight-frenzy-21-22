...
@Autonomous(name= "redbottom", group="Pushbot")
...
public class redbottom extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        pause();
        runtime.reset();
        timedMotorPowers(-0.3,0, -0.3, 0, 1.216);
        sleep(500);
        timedMotorPowers(-BACK_SPEED, 0.5);
        timedMotorPowers(0.3, -0.3, -0.3, 0.3, 2.30);
        sleep(500);
        timedMotorPowers(0.50,1.15);
        runtime.reset();
