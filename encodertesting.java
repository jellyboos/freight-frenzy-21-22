...
public class encodertesting extends LinearOpMode {
    ...
    public void encoderDrive(double speed, double leftFront, double rightFront, double leftBack, double rightBack) {
        ...
        if (opModeIsActive()) {
            ...
            telemetry.addData("old target", robot.leftBack.getCurrentPosition());
;            robot.leftFront.setTargetPosition(newLeftFrontTarget);
            robot.leftBack.setTargetPosition(newLeftBackTarget);
            robot.rightFront.setTargetPosition(newRightFrontTarget);
            robot.rightBack.setTargetPosition(newRightBackTarget); //427
            telemetry.addData("new target", robot.leftBack.getTargetPosition());
            telemetry.update();
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("left front busy", robot.leftFront.isBusy());
                telemetry.addData("left back busy", robot.leftBack.isBusy());
                telemetry.addData("right front busy", robot.rightFront.isBusy());
                telemetry.addData("right back busy", robot.rightBack.isBusy());
                ...
                telemetry.addData("right back pos", robot.rightBack.getCurrentPosition());
                telemetry.update();
            }
